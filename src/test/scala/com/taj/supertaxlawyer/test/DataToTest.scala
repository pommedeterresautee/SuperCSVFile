...
object DataToTest {
  ...
  val utf8 = TestContainer("utf8_file_bis.txt", 3, List(3, 16, 10, 8, 10, 50, 10, 20, 14, 8, 12, 9, 9, 11, 8, 8), List(3, 16, 10, 8, 10, 50, 1, 1, 14, 8, 12, 9, 9, 11, 8, 8), "\t", "UTF-8", 5)
  val fake_utf8_bis = TestContainer("utf8_file.txt", 3, List(24, 23, 27), List(24, 23, 23), ";", "ISO-8859-1", 2)
}